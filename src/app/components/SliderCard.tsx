...
export function SliderCard({
  ...
  return (
    <div className="border-baykar-light-blue flex h-full flex-col items-start gap-6 rounded-[1.25rem] border bg-white p-6 shadow-lg shadow-black/20 desktop:gap-4 desktop:p-8">
      <Image
